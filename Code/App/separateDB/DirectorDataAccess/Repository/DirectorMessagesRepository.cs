...
{
    public class DirectorMessagesRepository : RepositoryBase<DirectorMessages, KSR_DirectorEntities>, IDirectorMessagesRepository
    {
        private readonly IUnitOfWork _unitOfWork;

        public DirectorMessagesRepository(KSR_DirectorEntities context,
